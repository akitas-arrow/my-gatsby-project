...
function about() {
    ...
    const data2 = [
        ...
        {
            th: '取扱メーカー',
            td:['花王（家庭品代行店・業務品特約店、ライオン、エステー、小林製薬、クラシエ、サラヤ、ユニリーバ、クレハ、NSファーファジャパン、アース製薬、クレシア、大王製紙、カメヤマ、東芝、その他']
        },
        {
            th: '主な取引先',
            td:['薬局・ドラッグストア、雑貨問屋、スーパーマーケット、ホテル、レストラン・飲食店、結婚式場、老人保健施設、病院、その他']
        }
    ]
